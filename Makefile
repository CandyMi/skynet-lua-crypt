...
LUA_CLIB_SKYNET = \
  ...
  lua-multicast.c \
  lua-cluster.c \
  lua-crypt.c lsha1.c lcrc.c lsha256.c \
  lua-sharedata.c \
  lua-stm.c \
  lua-debugchannel.c \
  lua-datasheet.c \
...
$(LUA_CLIB_PATH)/client.so : lualib-src/lua-clientsocket.c lualib-src/lua-crypt.c lualib-src/lsha1.c lualib-src/lcrc.c lualib-src/lsha256.c | $(LUA_CLIB_PATH)
